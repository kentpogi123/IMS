<?php
  ...
  if(!isset($_SESSION['user'])) header('location:index.php');
   $_SESSION['redirect_to'] = 'product-view-minimize.php';
				...
				<div class="dashboard_content_main">
					...
					<div class="column column-12">
							...
							<div class="dataTables_filter" id="manageProductTable_filter">
								...
								<div class="SeePIC">
								<span><a href="product-view.php"><i class="fa fa-image"></i>W/PICTURES</a></span>
							</div>
							</div></h1>
								...
								<div class="users">
									<table>
										...
										<tr>
											...
											<th>Product Type</th>
											<th >quantity</th>
											<th width="18%">MANUFACTURE & EXPIRATION DATE</th>
											<th>Create By</th>
										...
										<tbody id="showdata">
											...
											<tr>
												...
												<td><span id="date">CREATED BY: <span id="date0"><?= date('M d, Y @ h:i:s A', strtotime( $product["created_at"]))?></span></span><span id="date1">UPDATED AT: <span id="date2"><?= date('M d, Y @ h:i:s A', strtotime($product["updated_at"]))?></span></span></td>
												<td>
					...
					BootstrapDialog.confirm({
							...
							<div class="appFormInputContainer">\
									...
									<label id="labelquantity" for="quantity">Quantity</label>\
										<input type="number" name="quantity" placeholder="Enter Quantity" value="'+ productDetails.quantity +'">\
									</div>\
									<div class="appFormInputContainer4">\
									<label id="labelquantity" for="unit">Quantity Unit</label>\
										<input class="appFormInputquantity" type="text" name="unit" value="'+ productDetails.unit +'">\
									</div>\
