<?php
  ...
  if(!isset($_SESSION['user'])) header('location:index.php');
   $_SESSION['redirect_to'] = 'facility-view.php';
	...
	<div id="dashboardMainContainer">
		<?php include('partials/app-sidebar.php') ?>
			...
			<?php include('partials/app-topnav.php') ?>
			 <div class="printcss">
                <span class="printsee"><a href="facility-print-minimize.php"><i class="fa fa-image"></i>W/OPICTURES</a></span>
			...
			<div class="dashboard_content">
				<div class="dashboard_content_main">
					...
					<div class="column column-12">
							<h1 class="section_header"><i class="fa fa-list"></i>List of Equipments Facility</h1>
								...
								<div class="users">
									<table>
										...
										<tbody>
											...
											<tr>
												<td><?= $index + 1 ?></td>
												<td class="userPic"><img class="productImages" src="facilitypic/facpic/<?= $facility['facility_pic'] ?>"></td>
		...
		<script src="js/searchbarfacility.js"></script>
