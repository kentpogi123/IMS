<?php
  ...
  if(!isset($_SESSION['user'])) header('location:index.php');
   $_SESSION['redirect_to'] = 'tableware-viewmin.php';
...
<body>
				...
				<div class="dashboard_content_main">
					...
					<div class="column column-12">
							...
							<div class="dataTables_filter" id="manageProductTable_filter">
								...
								<div class="SeePIC">
								<span><a href="tableware-view.php"><i class="fa fa-image"></i>W/OPICTURES</a></span>
							</div>
							</div></h1>
									...
									<table>
										...
										<tbody id="showdata">
											...
											<tr>
												...
												<td class="<?=$warning?>"><?=$tableware['damage'] ?><?= $tableware['unit'] ?></td>
												<td class="<?=$alert?>"><?=$tableware['missing'] ?><?= $tableware['unit'] ?></td>
												<td>
													<?php
	...
	<script src="js/tableware-searchbarmin.js"></script>
