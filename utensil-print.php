<?php
  ...
  if(!isset($_SESSION['user'])) header('location:index.php');
   $_SESSION['redirect_to'] = 'utensil-view.php';
...
<body>
	<div id="dashboardMainContainer">
		<?php include('partials/app-sidebar.php') ?>
			...
			<div class="printcss">
                <span class="printsee"><a href="utensil-print-minimize.php"><i class="fa fa-image"></i>W/OPICTURES</a></span>
			...
			<div class="dashboard_content">
				<div class="dashboard_content_main">
					...
					<div class="column column-12">
							<h1 class="section_header"><i class="fa fa-list"></i>List of Utensils</h1>
									...
									<table>
										...
										<tbody id="showdata">
											...
											<tr>
												<td><?= $index + 1 ?></td>
												<td class="firstName">
													<img class="productImages" src="utensilpic/pics/<?= $utensil['utensil_pic'] ?>" alt="" />
												</td>
	...
	<script src="js/utensil-searchbar.js"></script>
