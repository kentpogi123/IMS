				...
				<div class="dashboard_content_main">
					...
					<div class="column column-12">
							...
							<div class="dataTables_filter" id="manageProductTable_filter">
								...
								<div class="SeePIC">
								<span><a href="utensil-viewmin.php"><i class="fa fa-image"></i>W/OPICTURES</a></span>
							</div>
							</div></h1>
									...
									<table>
										...
										<tbody id="showdata">
											...
											<tr>
												<td><?= $index + 1 ?></td>
												<td class="firstName">
													<img class="productImages" src="utensilpic/pics/<?= $utensil['utensil_pic'] ?>" alt="" /><a href="" class="updateUtensilPic" data-uid="<?= $utensil['id'] ?>"><i class="fa fa-image"></i>EDIT</a>
												</td>
