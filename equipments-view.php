				...
				<div class="dashboard_content_main">
					...
					<div class="column column-12">
							...
							<div class="dataTables_filter" id="manageProductTable_filter">
								...
								<div class="SeePIC2">
								<span><a href="equipments-view-minimize.php"><i class="fa fa-image"></i>W/OPICTURES</a></span>
							</div>
							</div></h1>
								...
								<div class="users">
									<table>
										...
										<tbody>
											...
											<tr>
												<td><?= $index + 1 ?></td>
												<td class="userPic"><img class="productImages" src="Equipmentsuploads/ENpics/<?= $equipment['EN_img'] ?>"><a href="" class="updateEquipmentpic " data-equipmentid="<?= $equipment['id'] ?>"><i class="fa fa-image"></i>EDIT</a></td>
